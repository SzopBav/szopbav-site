(function(){
  ...
  $$(".nav a, .btn").forEach(a=>a.addEventListener("click", e=>{
    ...
    if(href && href.startsWith("#")){
      e.preventDefault();
      const t=$(href);
      if(t){ window.scrollTo({top:t.offsetTop-72, behavior:"smooth"}); history.pushState(null,"",href); }
    }
  }));
  ...
  function setLang(lang){
    ...
    $$(".lng").forEach(b=>b.setAttribute("aria-pressed", b.dataset.lang===lang ? "true":"false"));
